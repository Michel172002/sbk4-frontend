...
function Table({ handleOpenModalEdit, handleOpenModalDados }) {
  ...
  const showDeleteModal = (id) => {
    ...
    setAlertMessage(
      `Você tem certeza que quer excluir o proprietario '${
        proprietarios.find((x) => x.id === id).nome
      }' e seus imoveis?`
    );
                ...
                <tr>
                  ...
                  <td className="teste">
                    <div className="td_Button">
                      <button
                        onClick={() => handleOpenModalDados(proprietario)}
                      >
                        <FaClipboardList />
                      </button>
                      <button onClick={() => handleOpenModalEdit(proprietario)}>
                        Editar
                      </button>
                      <button onClick={() => showDeleteModal(proprietario.id)}>
                        Apagar
                      </button>
                    </div>
                  </td>

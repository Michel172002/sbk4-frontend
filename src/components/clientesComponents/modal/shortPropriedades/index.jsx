...
const ShortPropriedades= () => {
  ...
  const [procComodos, setComodos] = useState("")
    ...
    const createCliente = async(e) => {
      const cliente = {nome, dataNas, sexo, telefone, email, identificacao, identificacaoNumber, observacao, procTipo, procAlugando, procComodos}
            ...
            <div class="col align-self-center">
                ...
                <div class="row justify-content-around">
                    <div class="col-auto">
                        ...
                        <div>
                            <select class="form-control" name="sexo" id="selectSexo" onChange={(e) => setSexo(e.target.value === "true")}>
                ...
                <div class="row justify-content-around">
                    ...
                    <div class="col-auto mb-3">
                        ...
                        <div class="col-auto offset-md-3">
                            ...
                            <div>
                                <div>
                                    <input type="radio" id="alugar" name="tipoRadio" value={true} onChange={() => setAlugar(true)}></input>
                                    <label htmlFor="alugar">Alugar</label>
                                </div>
                                <div>
                                    <input type="radio" id="comprar" name="tipoRadio" value={false} onChange={() => setAlugar(false)}></input>
